            ...
            <div className="p-6 space-y-6">
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  ...
                  <div className={cn(
                    ...
                    isEmailContextNode ? "bg-purple-500/20 text-purple-600 dark:text-purple-400" :
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  {/* Email Context Node Configuration */}
                  {isEmailContextNode && (
                    <div className="space-y-4 rounded-md border p-3 bg-muted/20">
                      <h4 className="text-sm font-medium">Context Value</h4>
                      <p className="text-xs text-muted-foreground mb-2">
                        Define the specific context this node provides to email generation.
                      </p>
                      ...
                      <div className="space-y-2">
                        <label className="text-xs font-medium">
                          ...
                          <Input
                            className="mt-1"
                            placeholder={
                              selectedNode.type === "persona" ? "e.g., Marketing Manager, CTO, Small Business Owner" :
                              selectedNode.type === "industry" ? "e.g., SaaS, E-commerce, Healthcare" :
                              selectedNode.type === "painpoint" ? "e.g., Manual data entry, Slow response times" :
                              selectedNode.type === "metric" ? "e.g., Time saved per week, Cost reduction %" :
                              selectedNode.type === "urgency" ? "e.g., End of quarter, New regulation deadline" :
                              selectedNode.type === "socialproof" ? "e.g., 500+ companies automated, 98% satisfaction" :
                              selectedNode.type === "objection" ? "e.g., No technical skills needed, Free trial available" :
                              selectedNode.type === "value" ? "e.g., 10x faster, 50% cost reduction" :
                              "Enter context value..."
                            }
                      ...
                      <div className="mt-2 text-xs text-muted-foreground">
                        <p className="font-medium mb-1">How this affects emails:</p>
                        ...
                        {selectedNode.type === "painpoint" && 
                          "Emphasizes solutions to this specific problem in the email content."}
                        {selectedNode.type === "metric" && 
                          "Highlights this success metric prominently in the value proposition."}
                        ...
                        {selectedNode.type === "objection" && 
                          "Proactively addresses this concern to reduce friction."}
                        {selectedNode.type === "value" && 
                          "Emphasizes this specific benefit in the email messaging."}
                      </div>
                    </div>
                  )}
              ...
              {/* ROI Contribution Card - Only show for non-email-context nodes */}
              {!isEmailContextNode && (
                <Card>
