  ...
  const generateFactors = useCallback(async () => {
    ...
    try {
      ...
      const request: GenerateROIFieldsRequest = {
        taskType: (taskType as TaskType) || 'internal_admin',
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <SelectContent className="bg-background/95 backdrop-blur-sm border shadow-lg">
                      ...
                      <SelectItem value="data_cleaning">Data Cleaning or Entry</SelectItem>
                      <SelectItem value="scheduling">Scheduling or Routing</SelectItem>
                      <SelectItem value="reporting">Reporting or Dashboards</SelectItem>
                      <SelectItem value="onboarding">Onboarding or Intake</SelectItem>
                      <SelectItem value="cross_platform_sync">Cross-Platform Sync</SelectItem>
                      <SelectItem value="outreach">Outreach or Follow-up</SelectItem>
                      <SelectItem value="lead_scoring">Lead Scoring or Qualification</SelectItem>
                      <SelectItem value="sales_enablement">Sales Enablement</SelectItem>
                      <SelectItem value="revenue_capture">Revenue Capture</SelectItem>
                      <SelectItem value="contract_legal">Contract or Legal</SelectItem>
                      <SelectItem value="booking_appointment">Booking or Appointment Flow</SelectItem>
                      <SelectItem value="pipeline_closing">Pipeline Movement or Closing</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
